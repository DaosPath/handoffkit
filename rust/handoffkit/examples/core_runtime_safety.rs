//! 1.19.0 mini-demo: structured handoff wire (Rust contracts).

use handoffkit::HandoffState;

fn main() {
    println!("handoffkit Rust - core_runtime_safety_demo (1.19.0)");
    ...
    let state = HandoffState {
        ...
        summary: "Python/JS demos + C++ handoffkit::core consumer smoke; no shell by default."
            .to_string(),
        decisions: vec![
            "Run HK-CSP 1.19.0 with stable contracts.".to_string(),
