...
Reports generated by the 1.1.0 demos:

| Demo | Report | Command |
|---|---|---|
| Coding agents | [`reports/coding_review.md`](reports/coding_review.md) | `handoffkit init coding-review` |
| Support escalation | [`reports/support_escalation.md`](reports/support_escalation.md) | `handoffkit init support-escalation` |
| Research workflow | [`reports/research_workflow.md`](reports/research_workflow.md) | `handoffkit init research-workflow` |
...
[`examples/langgraph_integration.py`](examples/langgraph_integration.py) and
