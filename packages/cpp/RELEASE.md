...
### After GitHub Release publishes `handoffkit-cpp-1.14.2.tar.gz`

1. Download `SHA256SUMS` from the release assets.
2. Put the hash into `conandata.yml` → `sources."1.14.2".sha256`.
...
FetchContent_Declare(
  handoffkit
  URL https://github.com/DaosPath/handoffkit/releases/download/v1.14.2/handoffkit-cpp-1.14.2.tar.gz
