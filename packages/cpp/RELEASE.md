...
### After GitHub Release publishes `handoffkit-cpp-1.15.0.tar.gz`

1. Download `SHA256SUMS` from the release assets.
2. Put the hash into `conandata.yml` → `sources."1.15.0".sha256`.
...
FetchContent_Declare(
  handoffkit
  URL https://github.com/DaosPath/handoffkit/releases/download/v1.15.0/handoffkit-cpp-1.15.0.tar.gz
