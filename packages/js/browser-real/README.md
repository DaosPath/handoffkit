...
```bash
pnpm --dir packages/js/browser-real run install-chromium
```
...
```bash
HANDOFFKIT_BROWSER_REAL_PLAYWRIGHT=1 pnpm --dir packages/js/browser-real test test/playwright.test.js
