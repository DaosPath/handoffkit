...
- `C:\Users\jampi\AppData\Local\Programs\Python\Python314\python.exe -m pytest -q` in `C:\Hijosdelsol\handoffkit\packages\python\examples\output\calculator_cli`
