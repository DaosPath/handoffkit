...
def test_key_public_signatures_are_stable() -> None:
    ...
    expected = {
        ...
        "Team": "(agents: 'Sequence[Agent]', *, protocol: 'HandoffProtocol | None' = None, runtime_mode: 'RuntimeMode | str' = <RuntimeMode.CLASSIC: 'classic'>, runtime: 'CspRuntime | None' = None) -> 'None'",
        ...
        "RecipeRunner": "(recipe: 'Recipe', *, protocol: 'HandoffProtocol | None' = None, runtime_mode: 'RuntimeMode | str' = <RuntimeMode.CLASSIC: 'classic'>, runtime: 'CspRuntime | None' = None) -> 'None'",
