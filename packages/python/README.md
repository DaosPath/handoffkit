...
<img src="https://raw.githubusercontent.com/DaosPath/handoffkit/main/docs/python/assets/handoffkit-hero.svg" alt="HandoffKit: structured state transfer for multi-agent cross-runtime workflows" width="100%">
...
<img src="https://raw.githubusercontent.com/DaosPath/handoffkit/main/docs/python/assets/handoffkit-state-flow.svg" alt="HandoffKit turns fragile free text handoffs into structured HandoffState contracts" width="100%">
...
handoffkit/
  packages/
    ...
    python/
      ...
      tests/           # Python tests
  docs/
    python/             # Central Python guides, integrations, and demo index
  apps/
...
<img src="https://raw.githubusercontent.com/DaosPath/handoffkit/main/docs/python/assets/coding-review-terminal.svg" alt="Animated terminal demo of pip install handoffkit, coding-review init, report output, and context soup versus HandoffState" width="100%">

<img src="https://raw.githubusercontent.com/DaosPath/handoffkit/main/docs/python/assets/handoffkit-showcases.svg" alt="Three HandoffKit demos: coding agents, support escalation, and research workflow" width="100%">

<img src="https://raw.githubusercontent.com/DaosPath/handoffkit/main/docs/python/assets/handoffkit-report-gallery.svg" alt="HandoffKit report gallery for coding agents, support escalation, and research workflow" width="100%">
...
Technical post: [`Context Soup vs Contract Handoffs`](../../docs/python/CONTEXT_SOUP_VS_CONTRACT_HANDOFFS.md).
Launch copy for Hacker News, Reddit, X/LinkedIn, and LangGraph communities:
[`docs/python/launch/CONTEXT_SOUP_LAUNCH_KIT.md`](../../docs/python/launch/CONTEXT_SOUP_LAUNCH_KIT.md).
Full showcase gallery: [`docs/python/SHOWCASE_GALLERY.md`](../../docs/python/SHOWCASE_GALLERY.md).

## Visual Overview

<img src="https://raw.githubusercontent.com/DaosPath/handoffkit/main/docs/python/assets/handoffkit-trace-replay.svg" alt="HandoffKit RunTrace, FileTraceStore, ReplayRunner, and reports flow" width="100%">
...
Docs: [`docs/python/MEDIA_WORKFLOWS.md`](../../docs/python/MEDIA_WORKFLOWS.md).
...
Docs: [`docs/python/PROVIDERS.md`](../../docs/python/PROVIDERS.md).
...
- [`LangGraph`](../../docs/python/integrations/LANGGRAPH.md): graph nodes pass `HandoffState`,
- [`OpenAI Agents SDK`](../../docs/python/integrations/OPENAI_AGENTS.md): agent handoffs become auditable contracts,
- [`Pydantic AI`](../../docs/python/integrations/PYDANTIC_AI.md): typed outputs become workflow handoff state,
- [`OpenCode Go / Zen`](../../docs/python/integrations/OPENCODE.md): provider adapters route
  OpenCode model families to their matching API endpoint styles.
- [`Provider Registry`](../../docs/python/PROVIDERS.md): experimental provider listing,
...
See `docs/python/API_STABILITY.md` and `docs/python/ROAD_TO_1_0.md`.

## Road to 1.0

1.0.0 completes the first stable API commitment. The stable surface is
documented in `docs/python/PUBLIC_API.md`, migration notes live in
`docs/python/MIGRATION_1_0.md`, and runtime/test/provider support policy lives in
...
Docs:
[`docs/python/integrations/OPENCODE.md`](../../docs/python/integrations/OPENCODE.md) and
[`docs/python/PROVIDERS.md`](../../docs/python/PROVIDERS.md).
...
See `docs/python/RELEASE_PROCESS.md` for the full release checklist.
